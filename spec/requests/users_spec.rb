...
RSpec.describe 'User', type: :request do
  ...
  describe 'POST /users' do
    ...
    context 'when the request is valid' do
      before { post "/users", params: {handle: 'jondoe22', password: "password", password_confirmation: "password"}}
    ...
    context 'when the user already exists' do
      let!(:existingUser) { FactoryGirl.create(:user, handle: 'jondoe33', password: "password", password_confirmation: "password"}) }
      before { post "/users", params: {handle: 'jondoe33', password: "password", password_confirmation: "password"}}}
